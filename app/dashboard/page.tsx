...
export default function HomePage() {
  const { isAuthenticated, hasStore, hasChosenPlan, isLoading } = useAuth()
  const router = useRouter()

  useEffect(() => {
    // Redirecionar usuários logados para o fluxo apropriado
    if (!isLoading && isAuthenticated) {
      if (!hasStore) {
        // Se não tem loja, será redirecionado automaticamente pelo contexto
        return
      }
  ...
  }, [isAuthenticated, hasStore, hasChosenPlan, isLoading, router])
